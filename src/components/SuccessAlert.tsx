...
export function SuccessAlert({ message, onDismiss }: SuccessAlertProps) {
 ...
 exit={{ opacity:0, y: -20 }}
 className="bg-emerald-50 border border-emerald-200 text-emerald-800 rounded-lg p-4 flex items-start gap-4"
 >
 ...
 <button
 onClick={onDismiss}
 className="ml-4 text-emerald-800 hover:text-emerald-600"
 >
